...
export const SIGN_DICT: any = {
  ...
  EXCUSE:{cat:'polite',desc:'Fingertips brush across open palm.',frames:[W(-10,30,'flat',10,25,30,'flat',80),W(30,30,'flat',10,25,30,'flat',80)]},
  MOTHER:{cat:'family',desc:'Thumb taps chin.',frames:[W(5,-65,'five',-30,LL.x,LL.y,'rest',-10,'smile'),W(12,-55,'five',-30,LL.x,LL.y,'rest',-10,'smile'),W(5,-65,'five',-30,LL.x,LL.y,'rest',-10,'smile')]},
  FATHER:{cat:'family',desc:'Thumb taps forehead.',frames:[W(5,-90,'five',-30,LL.x,LL.y,'rest',-10),W(12,-80,'five',-30,LL.x,LL.y,'rest',-10),W(5,-90,'five',-30,LL.x,LL.y,'rest',-10)]},
  SISTER:{cat:'family',desc:'L-shape at chin moves down.',frames:[W(10,-60,'lshape',-30,25,-10,'lshape',90),W(25,-10,'lshape',0,25,-10,'lshape',90)]},
  BROTHER:{cat:'family',desc:'L-shape at forehead moves down.',frames:[W(10,-90,'lshape',-30,25,-10,'lshape',90),W(25,-10,'lshape',0,25,-10,'lshape',90)]},
  BABY:{cat:'family',desc:'Arms cradle side to side.',frames:[W(25,30,'flat',90,25,50,'flat',-90,'smile'),W(25,50,'flat',90,25,30,'flat',-90,'smile'),W(25,30,'flat',90,25,50,'flat',-90,'smile')]},
  HE:{cat:'pronoun',desc:'Index points to the side.',frames:[W(50,-10,'point',90,LL.x,LL.y,'rest',-10),W(50,-10,'point',90,LL.x,LL.y,'rest',-10)]},
  SHE:{cat:'pronoun',desc:'Index points to the side.',frames:[W(50,-10,'point',90,LL.x,LL.y,'rest',-10),W(50,-10,'point',90,LL.x,LL.y,'rest',-10)]},
  THEY:{cat:'pronoun',desc:'Open hand sweeps outward.',frames:[W(30,-10,'point',90,LL.x,LL.y,'rest',-10),W(60,-10,'point',90,LL.x,LL.y,'rest',-10)]},
  NEED:{cat:'verb',desc:'Index finger bends down.',frames:[W(35,-20,'point',0,LL.x,LL.y,'rest',-10),W(35,10,'point',0,LL.x,LL.y,'rest',-10),W(35,-20,'point',0,LL.x,LL.y,'rest',-10)]},
  HAVE:{cat:'verb',desc:'Bent fingertips touch chest.',frames:[W(30,-10,'bent',-45,30,-10,'bent',45),W(8,-10,'bent',-45,8,-10,'bent',45)]},
  GIVE:{cat:'verb',desc:'Flat-O opens outward.',frames:[W(10,-10,'oshape',-30,LL.x,LL.y,'rest',-10),W(50,-10,'flat',10,LL.x,LL.y,'rest',-10)]},
  TAKE:{cat:'verb',desc:'Open hand closes pulling in.',frames:[W(50,-10,'open',10,LL.x,LL.y,'rest',-10),W(10,-10,'fist',-30,LL.x,LL.y,'rest',-10)]},
  MAKE:{cat:'verb',desc:'Two fists meet and twist.',frames:[W(5,0,'fist',-45,5,0,'fist',45),W(5,0,'fist',45,5,0,'fist',-45)]},
  UNDERSTAND:{cat:'verb',desc:'Fist snaps open near forehead.',frames:[W(30,-90,'fist',-10,LL.x,LL.y,'rest',-10),W(30,-90,'point',-10,LL.x,LL.y,'rest',-10)]},
  SEE:{cat:'verb',desc:'Two fingers point from eyes.',frames:[W(18,-85,'peace',-30,LL.x,LL.y,'rest',-10),W(50,-65,'peace',20,LL.x,LL.y,'rest',-10)]},
  HEAR:{cat:'verb',desc:'Index points to ear.',frames:[W(35,-90,'point',-30,LL.x,LL.y,'rest',-10),W(30,-85,'point',-30,LL.x,LL.y,'rest',-10)]},
  SPEAK:{cat:'verb',desc:'Index circles at mouth.',frames:[W(18,-65,'point',-90,LL.x,LL.y,'rest',-10,'open'),W(35,-55,'point',-60,LL.x,LL.y,'rest',-10,'open'),W(18,-65,'point',-90,LL.x,LL.y,'rest',-10,'open')]},
  READ:{cat:'verb',desc:'Two fingers scan down palm.',frames:[W(30,-50,'peace',-90,30,-10,'flat',0),W(30,10,'peace',-90,30,-10,'flat',0)]},
  WRITE:{cat:'verb',desc:'Pinched fingers slide across palm.',frames:[W(10,10,'pinch',-90,30,10,'flat',0),W(50,10,'pinch',-90,30,10,'flat',0)]},
  FEEL:{cat:'verb',desc:'Middle finger brushes up chest.',frames:[W(8,30,'five',-90,LL.x,LL.y,'rest',-10),W(8,-30,'five',-90,LL.x,LL.y,'rest',-10)]},
  LEARN:{cat:'verb',desc:'Hand picks info off palm to head.',frames:[W(30,10,'claw',-10,30,30,'flat',90),W(25,-50,'pinch',-30,30,30,'flat',90)]},
  TEACH:{cat:'verb',desc:'Both flat-O hands move from head.',frames:[W(0,-70,'oshape',10,0,-70,'oshape',-10),W(35,-40,'oshape',30,35,-40,'oshape',-30)]},
  PLAY:{cat:'verb',desc:'Two Y-shapes shake at wrists.',frames:[W(25,-10,'yshape',-30,25,-10,'yshape',30),W(25,-10,'yshape',30,25,-10,'yshape',-30),W(25,-10,'yshape',-30,25,-10,'yshape',30)]},
  TIRED:{cat:'feeling',desc:'Bent hands tip downward.',frames:[W(5,-10,'bent',-45,5,-10,'bent',45,'frown',5),W(15,20,'bent',-45,15,20,'bent',45,'frown',8)]},
  HUNGRY:{cat:'feeling',desc:'C-hand drags down chest.',frames:[W(8,-50,'cshape',-90,LL.x,LL.y,'rest',-10),W(8,10,'cshape',-90,LL.x,LL.y,'rest',-10)]},
  THIRSTY:{cat:'feeling',desc:'Index drags down throat.',frames:[W(12,-80,'point',-90,LL.x,LL.y,'rest',-10),W(8,-30,'point',-90,LL.x,LL.y,'rest',-10)]},
  FINE:{cat:'feeling',desc:'Five-hand thumb taps chest.',frames:[W(5,-10,'five',-90,LL.x,LL.y,'rest',-10,'smile'),W(12,-10,'five',-90,LL.x,LL.y,'rest',-10,'smile')]},
  RED:{cat:'color',desc:'Index drags down lips.',frames:[W(18,-65,'point',-90,LL.x,LL.y,'rest',-10),W(18,-50,'point',-90,LL.x,LL.y,'rest',-10)]},
  BLUE:{cat:'color',desc:'B-hand twists at wrist.',frames:[W(35,-10,'flat',-45,LL.x,LL.y,'rest',-10),W(35,-10,'flat',45,LL.x,LL.y,'rest',-10),W(35,-10,'flat',-45,LL.x,LL.y,'rest',-10)]},
  GREEN:{cat:'color',desc:'G-shape twists at wrist.',frames:[W(35,-10,'point',60,LL.x,LL.y,'rest',-10),W(35,-10,'point',100,LL.x,LL.y,'rest',-10),W(35,-10,'point',60,LL.x,LL.y,'rest',-10)]},
  YELLOW:{cat:'color',desc:'Y-shape twists at wrist.',frames:[W(35,-10,'yshape',-45,LL.x,LL.y,'rest',-10),W(35,-10,'yshape',45,LL.x,LL.y,'rest',-10),W(35,-10,'yshape',-45,LL.x,LL.y,'rest',-10)]},
  BLACK:{cat:'color',desc:'Index drags across forehead.',frames:[W(-15,-90,'point',0,LL.x,LL.y,'rest',-10),W(50,-90,'point',0,LL.x,LL.y,'rest',-10)]},
  WHITE:{cat:'color',desc:'Open hand closes moving outward.',frames:[W(8,-10,'five',-90,LL.x,LL.y,'rest',-10),W(35,-10,'oshape',-90,LL.x,LL.y,'rest',-10)]},
  CAR:{cat:'noun',desc:'Fists turn steering wheel.',frames:[W(30,-10,'fist',-30,30,30,'fist',30),W(30,30,'fist',-30,30,-10,'fist',30),W(30,-10,'fist',-30,30,30,'fist',30)]},
  PHONE:{cat:'noun',desc:'Y-shape held to ear.',frames:[W(35,-85,'yshape',-45,LL.x,LL.y,'rest',-10),W(32,-80,'yshape',-45,LL.x,LL.y,'rest',-10)]},
  COMPUTER:{cat:'noun',desc:'C-hand bumps up the arm.',frames:[W(25,10,'cshape',-10,30,30,'flat',0),W(25,-20,'cshape',-10,30,30,'flat',0)]},
  BOOK:{cat:'noun',desc:'Two flat hands open like a book.',frames:[W(25,0,'flat',60,25,0,'flat',-60),W(35,0,'flat',10,35,0,'flat',-10)]},
  FOOD:{cat:'noun',desc:'Pinched fingers tap lips.',frames:[W(20,-55,'pinch',90,LL.x,LL.y,'rest',-10),W(12,-60,'pinch',90,LL.x,LL.y,'rest',-10)]},
  WATER:{cat:'noun',desc:'W-shape taps chin.',frames:[W(18,-55,'three',-45,LL.x,LL.y,'rest',-10),W(12,-60,'three',-45,LL.x,LL.y,'rest',-10)]},
  COFFEE:{cat:'noun',desc:'Top fist grinds on bottom fist.',frames:[W(25,0,'fist',-30,25,30,'fist',30),W(30,-10,'fist',-30,25,30,'fist',30),W(25,0,'fist',-30,25,30,'fist',30)]},
  MONEY:{cat:'noun',desc:'Flat-O pats open palm.',frames:[W(30,10,'oshape',-45,30,30,'flat',0),W(30,30,'oshape',-45,30,30,'flat',0)]},
  TIME:{cat:'noun',desc:'Index taps wrist.',frames:[W(30,30,'point',-45,30,30,'flat',80),W(25,25,'point',-45,30,30,'flat',80)]},
  DAY:{cat:'noun',desc:'Index arm sweeps across body.',frames:[W(50,-85,'point',0,30,0,'flat',0),W(-30,-85,'point',0,30,0,'flat',0)]},
  NIGHT:{cat:'noun',desc:'Right hand bends over left.',frames:[W(30,-50,'flat',-10,30,30,'flat',0),W(30,0,'bent',-10,30,30,'flat',0)]},
  WHEN:{cat:'question',desc:'Right index circles left index.',frames:[W(50,-10,'point',-90,25,-10,'point',-90,'raised'),W(25,-25,'point',-90,25,-10,'point',-90,'raised')]},
  TOMORROW:{cat:'time',desc:'A-shape arcs forward from cheek.',frames:[W(25,-75,'fist',0,LL.x,LL.y,'rest',-10),W(50,-45,'fist',30,LL.x,LL.y,'rest',-10)]},
  YESTERDAY:{cat:'time',desc:'A-shape arcs backward from cheek.',frames:[W(25,-75,'fist',0,LL.x,LL.y,'rest',-10),W(0,-45,'fist',-30,LL.x,LL.y,'rest',-10)]},
  AGAIN:{cat:'misc',desc:'Bent hand swings into open palm.',frames:[W(50,0,'bent',-45,25,0,'flat',0),W(25,0,'bent',-45,25,0,'flat',0)]},
  START:{cat:'misc',desc:'Index twists between two fingers.',frames:[W(25,-10,'point',-45,25,-10,'peace',90),W(25,-10,'point',45,25,-10,'peace',90)]},
  // ── Days of the week ──────────────────────────────
  MONDAY:{cat:'day',desc:'M-hand circles slightly.',frames:[W(35,-10,'fist',-10,LL.x,LL.y,'rest',-10),W(35,-20,'fist',-10,LL.x,LL.y,'rest',-10),W(35,-10,'fist',-10,LL.x,LL.y,'rest',-10)]},
  TUESDAY:{cat:'day',desc:'T-hand circles slightly.',frames:[W(35,-10,'fist',8,LL.x,LL.y,'rest',-10),W(35,-20,'fist',8,LL.x,LL.y,'rest',-10),W(35,-10,'fist',8,LL.x,LL.y,'rest',-10)]},
  WEDNESDAY:{cat:'day',desc:'W-hand circles slightly.',frames:[W(35,-10,'three',0,LL.x,LL.y,'rest',-10),W(35,-20,'three',0,LL.x,LL.y,'rest',-10),W(35,-10,'three',0,LL.x,LL.y,'rest',-10)]},
  THURSDAY:{cat:'day',desc:'H-hand circles slightly.',frames:[W(35,-10,'peace',90,LL.x,LL.y,'rest',-10),W(35,-20,'peace',90,LL.x,LL.y,'rest',-10),W(35,-10,'peace',90,LL.x,LL.y,'rest',-10)]},
  FRIDAY:{cat:'day',desc:'F-hand circles slightly.',frames:[W(35,-10,'okay',0,LL.x,LL.y,'rest',-10),W(35,-20,'okay',0,LL.x,LL.y,'rest',-10),W(35,-10,'okay',0,LL.x,LL.y,'rest',-10)]},
  SATURDAY:{cat:'day',desc:'S-hand circles slightly.',frames:[W(35,-10,'fist',0,LL.x,LL.y,'rest',-10),W(35,-20,'fist',0,LL.x,LL.y,'rest',-10),W(35,-10,'fist',0,LL.x,LL.y,'rest',-10)]},
  SUNDAY:{cat:'day',desc:'Both open hands circle outward.',frames:[W(30,-10,'open',20,30,-10,'open',-20),W(50,-10,'open',40,50,-10,'open',-40),W(30,-10,'open',20,30,-10,'open',-20)]},

  // ── Months ────────────────────────────────────────
  JANUARY:{cat:'month',desc:'J-hand fingerspelled with small arc.',frames:[W(35,-10,'yshape',0,LL.x,LL.y,'rest',-10),W(35,-20,'yshape',10,LL.x,LL.y,'rest',-10)]},
  FEBRUARY:{cat:'month',desc:'F-hand twists twice.',frames:[W(35,-10,'okay',0,LL.x,LL.y,'rest',-10),W(35,-20,'okay',15,LL.x,LL.y,'rest',-10),W(35,-10,'okay',0,LL.x,LL.y,'rest',-10)]},
  MARCH:{cat:'month',desc:'M-hand moves forward.',frames:[W(20,-10,'fist',-10,LL.x,LL.y,'rest',-10),W(45,-10,'fist',-10,LL.x,LL.y,'rest',-10)]},
  APRIL:{cat:'month',desc:'A-hand moves forward.',frames:[W(20,-10,'fist',0,LL.x,LL.y,'rest',-10),W(45,-10,'fist',0,LL.x,LL.y,'rest',-10)]},
  MAY:{cat:'month',desc:'M-hand bends down.',frames:[W(35,-20,'fist',-10,LL.x,LL.y,'rest',-10),W(35,5,'fist',-10,LL.x,LL.y,'rest',-10)]},
  JUNE:{cat:'month',desc:'J-hand arcs down.',frames:[W(35,-20,'yshape',0,LL.x,LL.y,'rest',-10),W(35,5,'yshape',10,LL.x,LL.y,'rest',-10)]},
  JULY:{cat:'month',desc:'J-hand with index arc.',frames:[W(35,-10,'point',0,LL.x,LL.y,'rest',-10),W(35,-20,'yshape',10,LL.x,LL.y,'rest',-10)]},
  AUGUST:{cat:'month',desc:'A-hand twists.',frames:[W(35,-10,'fist',0,LL.x,LL.y,'rest',-10),W(35,-10,'fist',20,LL.x,LL.y,'rest',-10),W(35,-10,'fist',0,LL.x,LL.y,'rest',-10)]},
  SEPTEMBER:{cat:'month',desc:'S-hand moves forward.',frames:[W(20,-10,'fist',0,LL.x,LL.y,'rest',-10),W(45,-10,'fist',0,LL.x,LL.y,'rest',-10)]},
  OCTOBER:{cat:'month',desc:'O-hand twists.',frames:[W(35,-10,'oshape',0,LL.x,LL.y,'rest',-10),W(35,-10,'oshape',20,LL.x,LL.y,'rest',-10),W(35,-10,'oshape',0,LL.x,LL.y,'rest',-10)]},
  NOVEMBER:{cat:'month',desc:'N-hand circles.',frames:[W(35,-10,'fist',-10,LL.x,LL.y,'rest',-10),W(35,-20,'fist',-10,LL.x,LL.y,'rest',-10),W(35,-10,'fist',-10,LL.x,LL.y,'rest',-10)]},
  DECEMBER:{cat:'month',desc:'D-hand circles.',frames:[W(35,-10,'point',0,LL.x,LL.y,'rest',-10),W(35,-20,'point',0,LL.x,LL.y,'rest',-10),W(35,-10,'point',0,LL.x,LL.y,'rest',-10)]},

  // ── Animals ───────────────────────────────────────
  DOG:{cat:'animal',desc:'Snap fingers then pat thigh.',frames:[W(35,-10,'okay',0,LL.x,LL.y,'rest',-10),W(25,40,'flat',-90,LL.x,LL.y,'rest',-10),W(35,-10,'okay',0,LL.x,LL.y,'rest',-10)]},
  CAT:{cat:'animal',desc:'Pinch fingers from cheek outward — like whiskers.',frames:[W(15,-70,'pinch',-30,LL.x,LL.y,'rest',-10),W(45,-60,'pinch',-10,LL.x,LL.y,'rest',-10)]},
  BIRD:{cat:'animal',desc:'G-shape at mouth opens and closes — like a beak.',frames:[W(15,-65,'point',90,LL.x,LL.y,'rest',-10),W(15,-65,'peace',90,LL.x,LL.y,'rest',-10),W(15,-65,'point',90,LL.x,LL.y,'rest',-10)]},
  FISH:{cat:'animal',desc:'Flat hand waves side to side like a fish tail.',frames:[W(20,10,'flat',90,LL.x,LL.y,'rest',-10),W(45,10,'flat',80,LL.x,LL.y,'rest',-10),W(20,10,'flat',90,LL.x,LL.y,'rest',-10)]},
  LION:{cat:'animal',desc:'Claw hand moves back over head — like a mane.',frames:[W(5,-95,'claw',0,LL.x,LL.y,'rest',-10),W(-20,-70,'claw',0,LL.x,LL.y,'rest',-10)]},
  ELEPHANT:{cat:'animal',desc:'Hand sweeps down from nose — like a trunk.',frames:[W(8,-65,'cshape',-90,LL.x,LL.y,'rest',-10),W(8,10,'cshape',-60,LL.x,LL.y,'rest',-10)]},
  MONKEY:{cat:'animal',desc:'Both hands scratch the sides — like a monkey.',frames:[W(10,10,'claw',0,10,10,'claw',0),W(10,-10,'claw',0,10,-10,'claw',0),W(10,10,'claw',0,10,10,'claw',0)]},
  HORSE:{cat:'animal',desc:'U-hand at temple flaps down — like horse ears.',frames:[W(30,-90,'peace',-30,LL.x,LL.y,'rest',-10),W(30,-75,'bent',-30,LL.x,LL.y,'rest',-10),W(30,-90,'peace',-30,LL.x,LL.y,'rest',-10)]},
  COW:{cat:'animal',desc:'Y-hand at temple — like horns.',frames:[W(30,-90,'yshape',0,LL.x,LL.y,'rest',-10),W(30,-80,'yshape',10,LL.x,LL.y,'rest',-10)]},
  RABBIT:{cat:'animal',desc:'Two U-fingers bend down twice — like rabbit ears.',frames:[W(20,-80,'peace',0,LL.x,LL.y,'rest',-10),W(20,-65,'bent',0,LL.x,LL.y,'rest',-10),W(20,-80,'peace',0,LL.x,LL.y,'rest',-10)]},
  SNAKE:{cat:'animal',desc:'Index finger winds forward — like a snake.',frames:[W(10,-10,'point',90,LL.x,LL.y,'rest',-10),W(50,-10,'point',90,LL.x,LL.y,'rest',-10)]},
  BEAR:{cat:'animal',desc:'Both claws scratch the chest — like a bear.',frames:[W(10,-10,'claw',-45,10,-10,'claw',45),W(10,10,'claw',-45,10,10,'claw',45),W(10,-10,'claw',-45,10,-10,'claw',45)]},

  // ── Places ────────────────────────────────────────
  HOSPITAL:{cat:'place',desc:'H-fingers draw a cross on the arm.',frames:[W(30,10,'peace',-90,30,20,'flat',0),W(30,-10,'peace',-90,30,20,'flat',0),W(15,20,'peace',0,30,20,'flat',0)]},
  STORE:{cat:'place',desc:'Flat-O hands swing forward twice.',frames:[W(25,10,'oshape',-30,25,10,'oshape',30),W(40,-5,'oshape',-10,40,-5,'oshape',10),W(25,10,'oshape',-30,25,10,'oshape',30)]},
  MOSQUE:{cat:'place',desc:'Both flat hands form a dome shape.',frames:[W(30,-30,'flat',45,30,-30,'flat',-45),W(10,-50,'flat',10,10,-50,'flat',-10)]},
  CHURCH:{cat:'place',desc:'C-hand taps the back of the fist.',frames:[W(25,-10,'cshape',0,25,20,'fist',0),W(25,5,'cshape',0,25,20,'fist',0),W(25,-10,'cshape',0,25,20,'fist',0)]},
  PARK:{cat:'place',desc:'P-hand moves in a small arc.',frames:[W(35,-20,'three',90,LL.x,LL.y,'rest',-10),W(35,0,'three',90,LL.x,LL.y,'rest',-10)]},
  HOTEL:{cat:'place',desc:'H-fingers tap the palm twice.',frames:[W(25,0,'peace',-30,30,10,'flat',0),W(25,15,'peace',-30,30,10,'flat',0),W(25,0,'peace',-30,30,10,'flat',0)]},
  AIRPORT:{cat:'place',desc:'Y-hand swoops upward — like a plane taking off.',frames:[W(10,20,'yshape',0,LL.x,LL.y,'rest',-10),W(40,-40,'yshape',-30,LL.x,LL.y,'rest',-10)]},
  RESTAURANT:{cat:'place',desc:'R-fingers tap each cheek.',frames:[W(15,-70,'rshape',0,LL.x,LL.y,'rest',-10),W(35,-70,'rshape',0,LL.x,LL.y,'rest',-10)]},
  LIBRARY:{cat:'place',desc:'L-hand circles.',frames:[W(35,-10,'lshape',0,LL.x,LL.y,'rest',-10),W(35,-25,'lshape',10,LL.x,LL.y,'rest',-10),W(35,-10,'lshape',0,LL.x,LL.y,'rest',-10)]},
  UNIVERSITY:{cat:'place',desc:'U-hand circles then lands on palm.',frames:[W(35,-20,'peace',0,LL.x,LL.y,'rest',-10),W(35,0,'peace',0,LL.x,LL.y,'rest',-10)]},
  MARKET:{cat:'place',desc:'Flat-O hands swing forward.',frames:[W(20,10,'oshape',-20,LL.x,LL.y,'rest',-10),W(45,5,'oshape',10,LL.x,LL.y,'rest',-10)]},
};
